...
class Website extends CI_Controller {
	...
	public function __construct()
	{
		...
		if (isset($_GET['utm_adset'])) {
			$_SESSION['UTM_ADSET'] = $_GET['utm_adset'];
		}
		...
		if (isset($_GET['utm_ad'])) {
			$_SESSION['UTM_AD'] = $_GET['utm_ad'];
		}
		if (isset($_GET['utm_site'])) {
			$_SESSION['UTM_SITE'] = $_GET['utm_site'];
		}
...
//utm new
		...
		$utm_adset = isset($_SESSION['UTM_ADSET']) ? $_SESSION['UTM_ADSET'] : '';
		$utm_placement = isset($_SESSION['UTM_PLACEMENT']) ? $_SESSION['UTM_PLACEMENT'] : '';
		$utm_term = isset($_SESSION['UTM_TERM']) ? $_SESSION['UTM_TERM'] : '';
		$utm_ad = isset($_SESSION['UTM_AD']) ? $_SESSION['UTM_AD'] : '';
		$utm_site = isset($_SESSION['UTM_SITE']) ? $_SESSION['UTM_SITE'] : '';
		...
		if(checkToken($csrf_token,'book_now')){
			...
			//utm new
				$api_data["00N2800000IQro9"] = $utm_adset;
				$api_request .= "&00N2800000IQro9=".$utm_adset;

				$api_data["00N2800000IQroA"] = $utm_placement;
				$api_request .= "&00N2800000IQroA=".$utm_placement;

				$api_data["00N2800000IQroB"] = $utm_term;
				$api_request .= "&00N2800000IQroB=".$utm_term;

				$api_data["00N2800000IQroF"] = $utm_ad;
				$api_request .= "&00N2800000IQroF=".$utm_ad;

				$api_data["00N2800000IQroH"] = $utm_site;
				$api_request .= "&00N2800000IQroH=".$utm_site;

				$api_data["00N0K00000K2Tgr"] = $utm_content;
				$api_request .= "&00N0K00000K2Tgr=".$utm_content;
			//utm new
