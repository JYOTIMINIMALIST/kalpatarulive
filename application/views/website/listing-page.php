...
<head>
    ...
    <title>Best Residential Projects in Mumbai,Pune, Hyderabad,Lonavala, Noida India | Kalpataru</title>
    <meta name="description" content="Kalpataru is a leading real estate developer in India. We are renowned for our quality residential projects. Choose from a wide range of apartments and villas for sale.">
<?php } ?>
<?php if($property_type == 'commercial'){ ?>
<title>Commercial Properties, Office Spaces in Mumbai, Pune | Kalpataru</title>
    <meta name="description" content="Kalpataru  is a leading commercial property developer in India. We have a wide range of new commercial projects offering commercial office spaces & retail spaces.">
<?php } ?>
            ...
            <div class="page-body">
                ...
                <?php if($property_type == 'residential'){ ?>
                    <div class="common_banner backgroundImg position-relative">
                        ...
                        <img class="w-100 d-none d-lg-block allDesktopBanner" src="<?php echo base_url() ?>assets_web/images/residentialBanner.webp" alt="New And Ongoing Residential Projects">
                        <img class="w-100 d-block d-lg-none allMobileBanner" src="<?php echo base_url() ?>assets_web/images/home-banner-mobile-01.webp" alt="New And Ongoing Residential Projects">
                ...
                <?php if($property_type == 'commercial'){ ?>
                    <div class="common_banner backgroundImg position-relative">
                        ...
                        <img class="w-100 d-none d-lg-block allDesktopBanner" src="<?php echo base_url() ?>assets_web/images/commercial-banner.webp" alt="Ongoing Commercial Projects">
                        <img class="w-100 d-block d-lg-none allMobileBanner" src="<?php echo base_url() ?>assets_web/images/commercial-banner-mobile.webp" alt="Commercial Properties">
...
<script type="text/javascript">
    ...
    function loadMore()
    {
        ...
        for (var i = data_from; i <= data_to; i++) {
            ...
            if (key==0 || key%2==0) {   
                //+title+'/'+ongoing[i].id+'                           
               // data_html += '<div class="swiper-slide home-featured-list-item w-100 col-9 p-0 scroll-to-'+ongoing[i].id+'"> <a href="<?=base_url()?>'+ongoing[i].city_slug+'/'+ongoing[i].slug+'"> <div class="home-featured-list-item-container row align-items-center justify-content-center"> <div data-aos="fade" data-aos-delay="100" data-aos-offset="0" class="home-featured-list-img col-md-7 col-12"> <div class="home-featured-list-img-container"> <img src="'+ongoing[i].thumbnail_image+'" class="w-100" alt="'+ongoing[i].thumbnail_imagealt+'"> </div> </div> <div class="home-featured-list-text-container col-md-5 col-12"> <div class="home-featured-list-text"> <h2 data-aos="fade" data-aos-delay="100" data-aos-offset="0" class="home-featured-list-project-name">'+ongoing[i].title+'</h2></div> <div data-aos="fade" data-aos-delay="200" data-aos-offset="0" class="home-featured-list-project-location Roboto-Regular">'+ongoing[i].location_name+'</div> <div data-aos="fade" data-aos-delay="300" data-aos-offset="0" class="home-featured-list-project-bhkcount Roboto-Regular">'+ongoing[i].typology+'</div> <div data-aos="fade" data-aos-delay="400" data-aos-offset="0" class="home-featured-list-project-description Roboto-Regular">'+description+'</div> <div data-aos="fade" data-aos-delay="500" data-aos-offset="0" class="icon-button"><div class="round-button"><div class="circle"></div><i class="kalpataru-icon-arrow-right"></i></div> LEARN MORE</div> </div> </div> </div> </a></div>';
