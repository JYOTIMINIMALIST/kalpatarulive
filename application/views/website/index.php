...
@media (max-width:350px) {
    ...
    .home-banner-text-container .icon-button i{ left: 0px !important;top: 6px !important;}
}

.home-banner-text-container{justify-content: flex-end;}
</style>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        foreach ($slider as $key => $value) {    
                                               ...
                                               <div class="swiper-slide">
                                                <a href="<?=base_url().$value->city_slug.'/'.$value->slug?>"><?php /*=$title?>/<?=$value->id*/ ?>
                                                    ...
                                                    if(strpos($value->featured_video, 'amazonaws.com') !== false || strpos($value->featured_video, 'cloudfront.net') !== false || strpos($value->featured_video, 'http://localhost/kalpataru/') !== false){
                                                      ...
                                                      <div class="home-banner-text-container">
                                                        <div class="home-banner-text">
                                                            <div class="home-banner-project-name"><h2><?=$value->title?></h2></div>
                                           ...
                                           <div class="swiper-slide">
                                            <a href="<?=base_url().$value->city_slug.'/'.$value->slug?>"><?php /*=$title?>/<?=$value->id*/ ?>
                                                <img src="<?=$value->featured_images?>" alt="<?=$value->featured_img_alt?>"  class="w-100 d-none d-lg-block home-banner-img-bg">
                                                <img src="<?=$value->featured_images_mobile?>" alt="<?=$value->featured_ial_mobile?>" class="home-banner-img-bg w-100 d-block d-lg-none home-banner-img-bg">
                                                <div class="home-banner-text-container">
                                                    <div class="home-banner-text">
                                                        <div class="home-banner-project-name"><h2><?=$value->title?></h2></div>
                            ...
                            <div class="searchFilterHead d-flex align-items-center justify-content-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="filter_Search search-container" id="prefetch">
                                        ...
                                        <input type="search" name="search_box" id="search_textdata" class="search-text typeahead" placeholder="FIND YOUR NEXT HOME" >
                                        </form>
                                    </div>
                                    <span><span class="black-text">FIND YOUR NEXT</span> HOME</span>
                                </div>
                            ...
                            <div class="searchFilterDesktopTabs">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="propertyTypeTabWrap searchFilterDropdownWrapper d-flex justify-content-between list-group flex-row">
                                       <a class="propertyTypeTab active" data-value="residential" id="showda"  data-toggle="list" onclick="getCitiesFor('residential',1)" href="#residentialTabDesk">RESIDENTIAL</a>
                                        <a class="propertyTypeTab" data-value="commercial" id="hideda" data-toggle="list" onclick="getCitiesFor('commercial',1)" href="#commercialTabDesk">COMMERCIAL</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="home-featured-list-item-container row align-items-center justify-content-center">
                                            <div data-aos="fade" data-aos-delay="100" data-aos-offset="0" class="home-featured-list-img col-md-7 col-12">
                                                <div class="home-featured-list-img-container">
                                                    <img src="<?=$value->thumbnail_image?>" alt="<?=$value->thumbnail_imagealt?>" class="w-100"> 
                                                </div>                                      
                                            </div>
                                            <div class="home-featured-list-text-container col-md-5 col-12">
                                                <div class="home-featured-list-text">
                                                <div data-aos="fade" data-aos-delay="100" data-aos-offset="0" class="home-featured-list-project-name"><h2><?=$value->title?></h2></div>
            ...
            <div class="row">
                <div class="col-md-6 order-2 order-md-1">
                    ...
                    <div class="about-description">
                        <div data-aos="fade" data-aos-delay="100" data-aos-offset="0">We bring more than 5 decades of real estate Excellence to developing and building premium residential towers, gated communities, townships and office properties. Our 120+ awards & accolades are testimony to our legacy. </div>
                        <div class="row align-items-end">
                            <div class="col-md-4">
                                <div class="number-stats-list counter-box">
                                    <div class="number-stats-list-container" data-aos="fade" data-aos-delay="100">
                                        <div>
                                            <span class="number-stats-list-number count" counter-value="53" decimal-place="0">53</span><span>+</span>
                                        </div>
                                    ...
                                    <div class="number-stats-list-container" data-aos="fade" data-aos-delay="200">
                                        <div class="number-stats-list-number count" counter-value="22.39" decimal-place="2">22.39</div>
                                    ...
                                    <div class="number-stats-list-container" data-aos="fade" data-aos-delay="300">
                                        <div>
                                            <span class="number-stats-list-number count" counter-value="110" decimal-place="0">110</span><span>+</span>
                                        </div>
                                    ...
                                    <div class="number-stats-list-container" data-aos="fade" data-aos-delay="400">
                                        <div class="number-stats-list-number count" counter-value="19500" decimal-place="0">19,500</div>
                ...
                <div class="col-md-6 p-md-0 order-1 order-md-2">
                    ...
                    <img data-aos="fade" data-aos-delay="100" src="<?php echo $this->config->item('cdn_url'); ?>assets_web/images/home-about-us.jpg" class="w-100" alt="Premium Commercial Project">
