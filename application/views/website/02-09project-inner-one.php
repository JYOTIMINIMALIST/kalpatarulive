        ...
        <div class="page-body">
            ...
            <div class="common_banner backgroundImg position-relative <?php if ($properties->banner_type=='video') { echo "video_added"; } ?>">
                <?php
                    if($background){
                ?>
                    <img src="<?=$background?>" class="desktopInnImg w-100 d-none d-lg-block" title="" alt="<?=$value->featured_img_alt?>">
                    <img src="<?=$mobile_background?>" class="mobileInnImg w-100 d-block d-lg-none" title=""  alt="<?=$value->featured_ial_mobile?>">
                <?php
                    }
                ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="px-5" data-aos="fade">
                                    <img src="<?=$properties->overview_image?>" class="w-100" alt="<?=$value->overview_imagealt?>">
                                </div>
                            </div>
                                            ...
                                            <div class="swiper-slide p-0">
                                                <div class="overview-slider-container" data-aos="fade">
                                                    <div class="overview-slider-img" >
                                                        <img src="<?=isset($it[0]) ? $it[0] : ''?>" class="w-100" alt="<?=$value->overview_imagealt?>">
                                                    </div>
 ...
 <?php
                ...
                <div id="resources" class="project-inner-resources-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5 order-md-2" data-aos="fade"><img src="<?=$properties->resource_image?>" class="w-100" alt="<?=$value->resource_imagealt?>"></div>
                        ...
                        <div id="locate" class="project-inner-location-section no-overflow bigTitleAnimationSection container-fluid mainContainer">
                            ...
                            if ($properties->map_image!="") {
                                ...
                                <div class="map_image_wrap" data-aos="fade">
                                    <a target="_blank" href="<?=$properties->map_url?>"><img src="<?=$properties->map_image?>" class="w-100" alt="<?=$value->map_imagealt?>"></a>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets_web/images/50-years-of-KL/high speed lift 316-X-376-3C.jpg" class="w-100" title=" High Speed Elevators" alt=" Multitier Security">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="buildingLandmarksSlide" data-aos="fade">
                                             <img src="<?php echo base_url(); ?>assets_web/images/50-years-of-KL/3 tier security 316-X-376-4.jpg" class="w-100" title="3 Tier security" alt="High Speed Elevators                                         
