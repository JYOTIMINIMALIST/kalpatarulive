                ...
                <div id="overview" class="project-inner-overview-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                            <div class="double-main-heading" data-aos="fade"><h2 class="title_h2"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> OVERVIEW</h2></div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7 Roboto-Medium">
                                <div class="max-550 mx-auto">
                                    ...
                                    <p class="project-inner-description" data-aos="fade" data-aos-delay="200"><?=$properties->short_description?></p>
                                        ...
                                        foreach ($amenities as $key => $value) {
                                            ...
                                            <li data-aos="fade" data-aos-delay="300">
                                                <div class="grey-icon-bg">
                                                    <img src="<?=$value->icon?>" class="w-100 h-100" alt="<?=$properties->svgalt?>">
                                                </div>
                                                <?=$value->title?>
                                            </li>
                                            <?php
...
<?php /* ?>
                <div id="amenities" class="project-inner-amenities-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                            <h2 class="double-main-heading" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> AMENITIES</h2>
...
<div id="amenities" class="project-inner-amenities-section no-overflow bigTitleAnimationSection">
  <div class="container-fluid mainContainer">
    <div class="double-bg-header">
                            <div class="double-main-heading" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> AMENITIES</div>
                            <div class="double-bg-heading">AMENITIES</div>
                        </div>
    <div class="row hide-mobile">
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          ...
          <div class="amenitiess-slider-text"> Community Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <div class="amenitiess-slider-text">Health Club <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
          ...
          <div class="amenitiess-slider-text"> Celebration Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
          ...
          <div class="amenitiess-slider-text"> Forest Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
          ...
          <div class="amenitiess-slider-text"> Sensory Garden <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
          ...
          <div class="amenitiess-slider-text">Dune Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
          ...
          <div class="amenitiess-slider-text">Strolling Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
          ...
          <div class="amenitiess-slider-text"> Sound Of Nature Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
      ...
      <div class="col-sm-3" id="accordion">
        <div class="amenitiess-slider-container d-md-flex align-items-center aos-init aos-animate amenitiesNewtitle" data-aos="fade" data-toggle="collapse" data-parent="#accordion" href="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
          ...
          <div class="amenitiess-slider-text"> Fitness Park <img class="rotate1" src="https://ixdtm.com/projects/Kalpataru_dev/assets_web/images/downgoldenarrow.PNG" data-target="#sub1" data-toggle="collapse"> </div>
        </div>
    ...
    // include("property/amenities.php");
        ...
        ?>    
                ...
                <div id="resources" class="project-inner-resources-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                            <h2 class="double-main-heading" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> RESOURCES</h2>
                    ...
                    if($properties->rera!="" || $properties->map_image!=""){
                        ...
                        <div id="locate" class="project-inner-location-section no-overflow bigTitleAnimationSection container-fluid mainContainer">
                            <div>
                                <div class="double-bg-header">
                                    <h2 class="double-main-heading" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> LOCATE</h2>
                ...
                <div id="project_you_may_like" class="project-inner-project-you-may-like-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                            <div class="double-main-heading" data-aos="fade"><span id="project_you_may_like_no"></span>  PROJECTS YOU MAY LIKE</div>
                ...
                <?php foreach($topo as $bhk=>$value):?>
                    <?php foreach ($value as $item):?>
                        ...
                        <div class="col-md-3 col-6"  data-city="<?php echo $city_slug['slug'] ?>">
                            ...
                            <div class="project_as_per_typo"><a class="nav-link" href="<?=base_url().$bhk_config.'-apartments-in-'.$city_slug['slug'] ?>"><?php echo $bhk ?> apartments in <?php echo $item['city_name']; ?></a></div>
                        </div>
                    <?php endforeach;?>
                <?php endforeach; ?>
            </div>
