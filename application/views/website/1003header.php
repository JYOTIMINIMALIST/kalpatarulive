			  ...
			  <div class="locationsWrapper filter_Search" id="prefetch">
                ...
                <div class="propertyTypeTabs mb-3 w-100">
                    ...
                    <div class="propertyTypeTabWrap d-flex justify-content-between list-group flex-row">
                     ...
                     ?>
                     <a class="propertyTypeTab <?php if ($type=="RESIDENTIAL") {echo 'active';}?>" data-value="RESIDENTIAL" onclick="getCitiesFor('residential',2)"  data-toggle="list" href="#residentialTab">RESIDENTIAL</a>
                     <a class="propertyTypeTab <?php if ($type=="COMMERCIAL") {echo 'active';}?>" data-value="COMMERCIAL" onclick="getCitiesFor('commercial',2)" data-toggle="list" href="#commercialTab">COMMERCIAL</a>
                 </div>
             </div>
