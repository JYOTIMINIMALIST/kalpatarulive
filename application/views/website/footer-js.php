...
<?php }?>
<?php if($page1 == 'kalpataru-nri'){ ?>
<script type="text/javascript" src="https://www.kalpataru.com/assets_web/js/combine-min-nri.js"></script>
<?php } else {?>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets_web/js/validation.min.js"></script>
...
//utm new 
        var utm_adset = "<?=isset($_GET['utm_adset']) ? $_GET['utm_adset'] : ''?>";
        var utm_placement = "<?=isset($_GET['utm_placement']) ? $_GET['utm_placement'] : ''?>";
        var utm_term = "<?=isset($_GET['utm_term']) ? $_GET['utm_term'] : ''?>";
        var utm_ad = "<?=isset($_GET['utm_ad']) ? $_GET['utm_ad'] : ''?>";
        var utm_site = "<?=isset($_GET['utm_site']) ? $_GET['utm_site'] : ''?>";
