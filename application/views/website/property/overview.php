                ...
                <div id="overview" class="project-inner-overview-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                           ...
                           <h2 class="title_h2"> <?php //echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; 

                            if($result[0]->position_overview_position<10){ echo '0';}
                            echo $result[0]->position_overview_position;?> <?=strtoupper($properties->title)?> OVERVIEW</h2></div>
                            <div class="double-bg-heading">OVERVIEW</div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="px-5" data-aos="fade">
                                    <img src="<?=$properties->overview_image?>" alt="<?php if($properties->overview_imagealt!=''){ echo $properties->overview_imagealt; }else { echo 'Overview Image';}?>" class="w-100">
                                </div>
                            </div>
