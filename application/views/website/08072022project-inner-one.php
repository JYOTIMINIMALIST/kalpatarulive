                ...
                <div id="investment" class="project-inner-overview-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <div class="px-5" data-aos="fade">
                                <img src="<?php echo base_url(); ?>assets_web/images/50-years-of-KL/In.jpg" class="w-100">
                ...
                <div id="professional" class="project-inner-overview-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="row align-items-center" style="padding-top:23px;">
                            <div class="col-md-5">
                                <div class="px-5" data-aos="fade">
                                    <img src="<?php echo base_url(); ?>assets_web/images/50-years-of-KL/pj.jpg" class="w-100">
                                </div>
                            </div>
                            <div class="col-md-7 Roboto-Medium">
                                <div class="max-550 mx-auto">
                                <h1 class="project-inner-header" data-aos="fade" data-aos-delay="100">  Your business address matters</h1>
                                    ...
                                    <ul class="project-inner-description" style="font-size: 15px;">      
                                        ...
                                        <li>Multiple configurations available to suit every professional need – CAs, Consultants, Lawyers, Doctors and SMBs</li>
...
<div id="amenities" class="project-inner-amenities-section no-overflow bigTitleAnimationSection">
                ...
                <div class="buildingLandmarksWrapper bigTitleAnimationSection">
                    <div class="container container-left pr-0">
                            ...
                            <div style="font-size: 0.938em;
    color: #727171;
    font-weight: 500;" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0"."9"; ?><b style="margin-left:4px;font-weight:500;">GALLERY</b></div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="buildingLandmarksSlide" data-aos="fade">
                                            ...
                                            <div class="buildingLandmarksQualitiesTitle">3 tier security</div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="buildingLandmarksSlide" data-aos="fade">
