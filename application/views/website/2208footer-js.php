    ...
    .addTo(controller);
        ...
        $("form[name='book_popup_form']").validate({
          ...
          submitHandler: function(form, event) {
           ...
           var data = {"b_name":book_user_name,"b_email":book_user_email,"b_contactno":book_user_contact_number,"b_whatsapp":book_whatsapp,"url":url,"country":country,"device_type":device_type,"utm_source":utm_source,"utm_campaign":utm_campaign,"utm_medium":utm_medium,"csrf_token":csrf_token}; 
           $.ajax({
