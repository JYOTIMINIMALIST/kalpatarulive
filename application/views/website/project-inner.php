<?php include('common.php'); $page='project-inner'; 
 ...
 $id= $properties->id;
    ...
    $this->db->join('rera_details', 'properties.id = rera_details.property_id');
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TBV8RZ5"
...
{
$c=1;
    if($urll == '/kalpataru-aria' || $urll == '/raigad/kalpataru-aria' || $thepath == 'kalpataru-aria')
{
...
if($result[0]->position_videogallery_position==$i && $result[0]->position_videogallery_status==1)
{
    $n=1;
include("property/videogallery.php");
}
...
$ans = $a+$b+$c+$d+$e+$f+$g+$h+$ii+$j+$k+$l+$m+$n;
?>          
