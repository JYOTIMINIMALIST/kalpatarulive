                ...
                <div id="overview" class="project-inner-overview-section no-overflow bigTitleAnimationSection">
                    <div class="container-fluid mainContainer">
                        <div class="double-bg-header">
                            <div class="double-main-heading" data-aos="fade"><?php echo $sequence_no > 9 ? $sequence_no : "0".$sequence_no; ?> <?=strtoupper($properties->title)?> OVERVIEW</div>
                                            ...
                                            <div class="swiper-slide p-0">
                                                <div class="overview-slider-container" data-aos="fade">
                                                    <div class="overview-slider-img" >
                                                        <img src="<?=isset($it[0]) ? $it[0] : ''?>" class="w-100" alt="<?=$properties->overview_imagealt?>">
                                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var l = 0; l < value.property_details.length; l++) {
                            property_details += '<div class="swiper-slide"> <div class="you-may-like-slider-container" data-aos="fade"> <div class="you-may-like-slider-img"> <a href="' + value.property_details[l].rel_link + '"><img src="' + value.property_details[l].thumbnail_image + '" alt="<?=$properties->thumbnail_imagealt?>" class="w-100"></a> </div> <a href="' + value.property_details[l].rel_link + '"><div class="you-may-like-slider-heading"> ' + value.property_details[l].title + ' </div> <div class="you-may-like-slider-description d-flex justify-content-between"> <div class="you-may-like-slider-location">' + value.property_details[l].location_name + ', ' + value.property_details[l].city_name + '</div> <div class="you-may-like-slider-size">' + value.property_details[l].typology + '</div> </div></a> </div> </div>';
                        }
