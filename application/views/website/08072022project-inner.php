        ...
        <div class="page-body">
            ...
            <div class="common_banner backgroundImg position-relative <?php if ($properties->banner_type=='video') { echo "video_added"; } ?>">
                <?php
                    if($background){
                ?>
                    <img src="<?=$background?>" class="desktopInnImg w-100 d-none d-lg-block" title="" alt="main-banner">
                    <img src="<?=$mobile_background?>" class="mobileInnImg w-100 d-block d-lg-none" title="" alt="main-banner">
                <?php
                    }
                ?>
