...
if($page == '2-BHK-FLATS-APARTMENTS-FOR-SALE-IN-CHANDIVALI' || 
$page == '3-BHK-FLATS-APARTMENTS-FOR-SALE-IN-JUHU' || 
$page == '3-BHK-FLATS-APARTMENTS-FOR-SALE-IN-JUHU' || 
$page == '3-BHK-FLATS-APARTMENTS-FOR-SALE-IN-JUHU' || 
$page == '4-BHK-FLATS-APARTMENTS-FOR-SALE-IN-MATUNGA-EAST' || 
$page == '4-BHK-FLATS-APARTMENTS-FOR-SALE-IN-MATUNGA-EAST' || 
$page == '4-BHK-FLATS-APARTMENTS-FOR-SALE-IN-PAREL' || 
$page == '4-BHK-FLATS-APARTMENTS-FOR-SALE-IN-PAREL' || 
$page == '5-BHK-DUPLEX-FLATS-APARTMENTS-FOR-SALE-IN-PRABHADEVI'|| 
$page == '4-BHK-FLATS-APARTMENTS-FOR-SALE-IN-PAREL')
{
$vtitle = '';
}
 ...
 $vtitle = 'Residential & Commercial';
                ...
                <div class="listing_filter_section bigTitleAnimationSection" data-aos="fade" data-aos-delay="100" data-aos-offset="0">
                    <div class="container-fluid mainContainer">
                        ...
                        <h2 class="mb-0 History-Pro mobile_listing_main_title"><?php echo $urlmn;?><?php //substr($this->uri->segment(1), 12);?></h2>
            ...
            <div class="listing_page_section listing_on_going_section  bigTitleAnimationSection">
                <div class="container-fluid mainContainer">
                    <div class="double-bg-header">
                        <div class="double-main-heading double-main-heading-gold" data-aos="fade"><?php if($cntt>0){?>02<?php } else {?>01<?php } ?> ON GOING</div>
