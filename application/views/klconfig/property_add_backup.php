                            ...
                            <div class="step-content">
                              ...
                              <div class="row">
                                <div class="file-field input-field col s12">
                                  ...
                                  <div class="file-path-wrapper">
                                    <input class="validate file-path-basic" type="text" id="image_name" name="image_name" placeholder="Featured Images">
                        ...
                        <li class="step step-2 step-pointer">
                          ...
                          <div class="row">
                            <div class="file-field input-field col s12">
                              ...
                              <div class="file-path-wrapper">
                                <input class="validate file-path file-path-overview" type="text" id="image_overview" name="image_overview" placeholder="Overview image">
                  ...
                  <div class="step-content">
                    <form id="resources_details" name="resources_details">
                      ...
                      <div class="file-field input-field col s12">
                        ...
                        <div class="file-path-wrapper">
                          <input class="validate file-path file-path-basic" type="text" id="file_virtual_tour" name="file_virtual_tour" placeholder="Virtual Tour">
                  ...
                  <form id="map_details" name="map_details">
                    ...
                    <div class="row">
                      <div class="file-field input-field col s12">
                        ...
                        <div class="file-path-wrapper">
                          <input class="validate file-path file-path-basic" type="text" id="file_map_image" name="file_map_image" placeholder="Map Image">
                ...
                <div class="step-content">
                  <form id="video_details" name="video_details">
                    <div class="video_section">
                      <div class="row video_section_inner_0" style="box-shadow: 0px 0px 1px 0 rgba(123,31,162,.5);padding:5px;">
                        <div class="input-field col s11">
                          <label for="video_url">Video Url (Youtube):</label>
                          <input type="text" class="validate video-url" name="video_url" id="video_url">
                          <span class="error-video_url_0"></span>
                        </div>  
                      </div>
                    </div>
...
$("form[name='basic_details']").validate({
  ...
  submitHandler: function(form, event) {
   ...
   var top_picks = 0;
   var on_going = 0;
   if ($("input[name=top_picks]").prop( ":checked")) { 
     var top_picks = 1;
   } 
   if ($("input[name=on_going]").prop( ":checked")) { 
     var on_going = 1;
   } 
   var property_type = $("#property_type").val();
   var title = $("#title").val();
   ...
   var data = {"property_type":property_type,"top_picks":top_picks,"on_going":on_going,"title":title,"status":status,"location":location,"city":city,"price":price,"possession":possession,"typology":typology,"featured_images":featured_images,"thumbnail_images":thumbnail_images,"insert_id":insert_id}; 
   $.ajax({
