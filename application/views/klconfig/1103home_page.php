                              ...
                              <div class="col s12">
                                ...
                                <table class="bordered">
                                  ...
                                  <tbody id="slider_tbody">
                                    <tr> <td colspan="3" style="text-align: center;">Search peoperty by title</td> </tr>
                                  </tbody>
                                </table>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col s12">
                                <table class="bordered">
                                  ...
                                  <tbody id="featured_slider_tbody">
                                    <tr>
                            ...
                            <div class="row">
                              ...
                              <div class="col s12">
                                <table class="bordered">
                                  ...
                                  <tbody id="featured_featured_tbody">
                                    <tr>
                                      <td colspan="4" style="text-align: center;">No data found!</td>
                                    </tr>                                   
                                  </tbody>
    ...
    function getProperty(keyword,type)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          {
           if (type=="slider") {
            $("#slider_tbody").html('<tr> <td colspan="3" style="text-align: center;">Search peoperty with title</td> </tr>');
          }
          else
          {
            $("#featured_tbody").html('<tr> <td colspan="3" style="text-align: center;">Search peoperty with title</td> </tr>');
          }
        }
      }
    });
