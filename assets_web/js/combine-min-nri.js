...
$(function(){
  ...
  pagination: {
    ...
    //     $('.featuredSlider .swiper-filter').on( 'click', 'li', function() {
    ...
    //       $( '.swiper-filter li' ).removeClass( 'swiper-active' );
...
//       swiper = new Swiper('.featuredSlider  .swiper-container', {
...
//             el: '.featuredSlider .swiper-pagination',
...
//     //  swiper.slideTo(0); // Start from the first slide

//   //    swiper.autoplay.start(); // Start the autoplay
...
//       $('.swipedata').on('click', function() {

//         var selectedCategory = $(this).data('category');

    

//         $('.swipedata').removeClass('active');
...
//       });
    ...
    var building_Landmarks_Slider = new Swiper('.legancyCounterSlider .swiper-container', {
      ...
      pagination: {
        ...
        //     el: '.legancyCounterSlider .swiper-pagination',
        ...
        //     nextEl: '.legancyCounterSlider .swiper-button-next',



        //     prevEl: '.legancyCounterSlider .swiper-button-prev',
